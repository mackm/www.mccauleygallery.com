  ...
  <div class="content"<?php print $content_attributes; ?>>
    <?php
      ...
      if ($view_mode == 'rss') {
        ...
        print('<div class="field field-name-field-art-image field-type-image field-label-hidden">');
        print('<a href="/node/'.$field_artist['0']['nid'].'">');
        print('<img class="rss" title="'.$field_art_image['0']['title'].'" alt="'.$field_art_image['0']['alt'].'" src="'.file_create_url($content['field_art_image']['#object']->field_art_image['und']['0']['uri']).'" typeof="foaf:Image>"');
        print('</a></div>');
        hide($content['field_art_image']);
        ...
        print render($content['field_art_image']); 
        print render($title_prefix);
        print('<h2><a href="'.$node_url.'">'.$title.'</a></h2>');
        print render($title_suffix);
      }
